...
(function initTMDModelComparator() {
  ...
  function buildComparatorHTML() {
    ...
    return `
      <div id="tmd-comparator-modal" class="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-6 overflow-y-auto transition-opacity duration-300" style="background: rgba(4, 6, 12, 0.85) !important; backdrop-filter: blur(24px) saturate(140%) !important; -webkit-backdrop-filter: blur(24px) saturate(140%) !important;">
        <div class="relative w-full max-w-[1240px] max-h-[92vh] overflow-y-auto rounded-[24px] text-neutral-200 flex flex-col" style="background: linear-gradient(165deg, rgba(14, 19, 30, 0.90) 0%, rgba(8, 11, 19, 0.88) 100%) !important; backdrop-filter: blur(28px) saturate(150%) !important; -webkit-backdrop-filter: blur(28px) saturate(150%) !important; border: 1px solid rgba(255, 184, 0, 0.28) !important; box-shadow: 0 25px 90px rgba(0, 0, 0, 0.85), 0 0 50px rgba(245, 158, 11, 0.10), inset 0 1px 1px rgba(255, 255, 255, 0.12) !important;">
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="p-6 rounded-[22px] bg-gradient-to-r from-amber-500/20 via-[#182030] to-emerald-500/20 border border-amber-500/40 flex flex-wrap items-center justify-between gap-4">
              <div class="max-w-xl">
  ...
  window.tmdPrintComparison = function() {
    ...
    if (!printWindow) {
      alert('Por favor permita ventanas emergentes para generar el reporte impreso.');
      return;
    }
